...
class State():
    #Whenever an object of this class is called, this init gets executed. Simply it is a constructor for class State().
    ...
    def is_valid(self):
        if self.missionaryLeft >= 0 and self.missionaryRight >= 0 \
            ...
            and (self.missionaryRight == 0 or self.missionaryRight >= self.cannibalRight):
                ...
                return False
      #A function which compares 2 classes and returns whether they are equal or not. Will run when it is called          
    # def __eq__(self, other):
    #     #To check whether SELF and OTHER states are equal or not
    ...
    #         and self.missionaryRight == other.missionaryRight
       ...
       #USED FOR HASING. REDUCES SEARCH TIME                         
    # def __hash__(self):
